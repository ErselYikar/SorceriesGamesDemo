...
public class TutorAnimationTriggers
{
    public const string IDLE = "Idle";
    public const string RUNWITHSOURCE = "RunWithSource";
    public const string IDLEWITHSOURCE = "IdleWithSource";
...
public class CustomerAnimationTriggers
{
    public const string IDLE = "Idle";
    public const string IDLEWITHDRINK = "IdleWithDrink";
    public const string RUN = "Run";
    public const string RUNWITHDRINK = "RunWithDrink";
    public const string CHANGE = "Change";
    public const string POLEDANCE = "PoleDance";
    public const string POLEDANCEVIDEO = "PoleDanceVideo";
    public const string RNBDANCE = "RnBDance";
    public const string RNBDANCEVIDEO = "RnBDanceVideo";
    public const string SAMBADANCE = "SambaDance";
    public const string SAMBADANCEVIDEO = "SambaDanceVideo";
    public const string PAY = "Pay";
    public const string GRABDRINK = "GrabDrink";
...
public enum DanceVideoSpotStates
{
    Locked = 0,
    PartiallyLocked = 1,
    Available = 2,
